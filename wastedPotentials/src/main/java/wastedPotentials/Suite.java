...
public class Suite {
	    ...
	    public void addTest(String testname, String paramName, String paramValue, String className, String classPath) throws IOException {
	        Test test = new Test(testname);
	        test.addParam(paramName, paramValue);
	        Pattern.compile(",").splitAsStream(className).forEach(test::addClass);
	        for(String abc : className.split(",")) {
	        	File f = new File(classPath, abc + ".java");
